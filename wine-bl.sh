...
apt-get -qq -o=Dpkg::Use-Pty=0 install --install-recommends wine-stable-i386=5.0.2~bullseye wine-stable-amd64=5.0.2~bullseye wine-stable=5.0.2~bullseye winehq-stable=5.0.2~bullseye xvfb  libncurses6 libncurses6:i386
